...
[Стартовый код для реализации проекта](https://github.com/netology-code/pb-diplom/raw/refs/heads/master/tictactoe.zip). Выполните форк исходного проекта. Страница отображается во вкладке **result**, отладочная информация во вкладке **console**.
