...
[Стартовый код для реализации проекта](https://codesandbox.io/p/sandbox/2x59m4). Выполните форк исходного проекта. Страница отображается во вкладке **result**, отладочная информация во вкладке **console**.
