...
[Стартовый код для реализации проекта](https://www.jdoodle.com/ga/kuWbxkaC33SO4TQd7TL7XQ%3D%3D). Страница отображается во вкладке **result**, отладочная информация во вкладке **console**.
