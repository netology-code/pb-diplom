...
[Стартовый код для реализации проекта](https://stackblitz.com/edit/stackblitz-starters-ecojt3). Страница отображается во вкладке **result**, отладочная информация во вкладке **console**.
